...
- [x] Si todas las validaciones pasan sin warnings: imprime PASS y sale con 0
- [x] Si hay warnings: imprime WARN y sale con 0
- [x] Si hay error critico: imprime mensaje y sale con 1
- [x] Verifica esquema exacto (columnas y orden)
- [x] Verifica cobertura de 3 cultivos en >=10 municipios MVP en train
