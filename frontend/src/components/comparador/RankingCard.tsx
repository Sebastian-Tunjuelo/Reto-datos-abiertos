...
const RANK_CONFIG = [
  { emoji: "🏆", label: "1er lugar", ring: "ring-yellow-400", bg: "bg-yellow-50 dark:bg-yellow-950/20" },
  { emoji: "🥈", label: "2do lugar", ring: "ring-slate-400", bg: "bg-slate-50 dark:bg-slate-900/30" },
  { emoji: "🥉", label: "3er lugar", ring: "ring-amber-700/60", bg: "bg-orange-50 dark:bg-orange-950/20" },
];
  ...
  return (
    ...
    >
      ...
      <div>
        ...
        {item.error_msg && (
          <p className="text-xs text-muted-foreground mt-0.5">{item.error_msg}</p>
        )}
      </div>
      ...
      <div className="flex items-end gap-2">
        ...
        {hasData && <span className="text-xs text-muted-foreground mb-1">/ 100 pts</span>}
      </div>
